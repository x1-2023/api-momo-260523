...
class Momo
{
    ...
    private $URLAction = array(
        ...
        "M2MU_INIT"         => "https://owa.momo.vn/api/", // Chuyển tiền
        "M2MU_CONFIRM"      => "https://owa.momo.vn/api/", // Chuyển tiền
    ...
    public function SendMoney($receiver, $amount = 100, $comment = "")
    {
        ...
        if (!empty($result["errorCode"]) && $result["errorDesc"] != "Lỗi cơ sở dữ liệu. Quý khách vui lòng thử lại sau") {
            ...
            $ID = $result["momoMsg"]["replyMsgs"]["0"]["tranHisMsg"]["ID"];
    ...
    public function CheckHistoryV2($day, $limit)
    {
        ...
        foreach ($HisList as $transaction) {
            ...
            if($result['momoMsg']['status'] != 2) continue;
