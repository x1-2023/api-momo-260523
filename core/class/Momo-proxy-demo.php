<?php
// Nếu bạn muốn sài proxy, hãy đổi tên file này thành Momo.php và tìm $proxy = '103.177.35.33:3108:user:pass' rồi thay thành proxy của bạn, có thể mua proxy tại dichvu.dailysieure.com
...
class Momo
{
    ...
    {
        $ch = curl_init();
 $proxy = '103.177.35.33:3108:user:pass'; 
        $proxy = explode(":",$proxy);
